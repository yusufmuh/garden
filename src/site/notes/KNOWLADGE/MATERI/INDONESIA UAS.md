---
{"sticker":"emoji//1f6a9","dg-publish":true,"permalink":"/knowladge/materi/indonesia-uas/","dgPassFrontmatter":true,"noteIcon":"","created":"2024-07-02T07:21:11.048+07:00","updated":"2024-07-02T08:23:05.471+07:00"}
---
...
### **Paragraf Pembuka:** 
   Manajemen pemasaran **adalah** proses analisis, perencanaan, implementasi, serta pengendalian atas program-program yang didesain untuk menciptakan, membangun, dan menjaga pertukaran yang menguntungkan dengan pembeli sasaran untuk mencapai tujuan-tujuan organisasional atau tujuan-tujuan perusahaan.
### **Paragraf Inti:** 
   Manajemen pemasaran tidak hanya berfokus pada penjualan produk, tetapi juga pada pengembangan hubungan jangka panjang dengan pelanggan. Hal ini mencakup penelitian pasar untuk memahami kebutuhan dan keinginan konsumen, pengembangan produk yang memenuhi kebutuhan tersebut, serta komunikasi yang efektif untuk mempromosikan produk. Implementasi strategi pemasaran yang tepat juga melibatkan pengendalian dan evaluasi kinerja untuk memastikan bahwa tujuan perusahaan tercapai.
### **Paragraf Penutup:** 
   Dengan demikian, manajemen pemasaran bertugas untuk memasarkan produk perusahaan, sehingga tercapai tingkat keuntungan jangka panjang perusahaan dan menjamin kelangsungan hidup serta pengembangan perusahaan.

## 2. Membuat paragraph akademik
### **Paragraf Akademik tentang Manajemen Pemasaran:** 
   Manajemen pemasaran memainkan peran penting dalam keberhasilan perusahaan. Proses ini melibatkan analisis kebutuhan pasar, perencanaan strategi pemasaran, implementasi program pemasaran, dan pengendalian hasil untuk memastikan tujuan bisnis tercapai. Dengan pendekatan yang sistematis dan terukur, manajemen pemasaran membantu perusahaan menciptakan nilai bagi pelanggan dan mempertahankan keunggulan kompetitif di pasar. Melalui penelitian pasar yang mendalam, perusahaan dapat mengidentifikasi tren dan preferensi konsumen, memungkinkan mereka untuk menyesuaikan produk dan layanan agar lebih sesuai dengan kebutuhan pelanggan.

---

# **LO3 karya ilmiah**
**Artikel Ilmiah dan Proposal Penelitian**
## **ABSTRAK:**

### 1. **Latar Belakang:** 
   Komunikasi interpersonal adalah komponen penting dalam berbagai aspek kehidupan, termasuk dalam konteks kesehatan dan kebugaran.
### 2. **Tujuan:** 
   Penelitian ini bertujuan untuk memahami pentingnya komunikasi interpersonal antara instruktur dan anggota fitness dalam mencapai gaya hidup sehat.
### 3. **Metode:** 
   Metode yang digunakan adalah studi literatur dan observasi langsung di beberapa pusat kebugaran.
### 4. **Hasil, Pembahasan, Kesimpulan:** 
   Hasil penelitian menunjukkan bahwa komunikasi yang efektif antara instruktur dan anggota dapat meningkatkan motivasi dan kepatuhan anggota terhadap program latihan, yang berujung pada pencapaian gaya hidup sehat.
## **Kata Kunci:** 
...
- Apa ***perbedaan*** komunikasi interpersonal dengan intrapersonal dan impersonal **?**
## **Tujuan** **penelitian**
- Menjelaskan **konsep** komunikasi interpersonal.
- Menjelaskan ***pentingnya*** komunikasi interpersonal.
- Menjelaskan ***perbedaan*** **antara** komunikasi interpersonal, intrapersonal, dan impersonal.
## **Manfaat** **penelitian**:
   ***Penelitian ini bermanfaat bagi pemangku kepentingan yang membutuhkan*** informasi tentang komunikasi interpersonal, terutama dalam konteks kesehatan dan kebugaran. **Manfaatnya** meliputi peningkatan pemahaman tentang pentingnya komunikasi yang efektif untuk mencapai tujuan kesehatan.
...
- **Studi Kasus:** Meneliti satu atau beberapa **kasus** dalam konteks tertentu.
    ...
    - **Contoh:** Penelitian tentang pengalaman siswa dalam menggunakan platform pembelajaran daring di satu sekolah.
- **Etnografi:** **Mengamati dan berpartisipasi** dalam kehidupan sehari-hari komunitas untuk memahami budaya mereka.
    - **Cara Menggunakan:** Habiskan waktu **di lapangan**, catat pengamatan dan wawancara, analisis data untuk memahami norma dan nilai budaya.
    - **Contoh:** Studi tentang kebiasaan makan masyarakat suku di pedalaman Papua.
- **Fenomenologi:** Mengeksplorasi pengalaman subyektif individu terhadap suatu fenomena.
    - **Cara Menggunakan:** Lakukan wawancara mendalam, analisis deskripsi pengalaman untuk menemukan tema umum.
...
- **Eksperimen:** Mengontrol **variabel independen** untuk melihat efeknya terhadap **variabel dependen.**
    ...
    - **Contoh:** Pengaruh metode belajar tertentu terhadap hasil ujian siswa.
- **Survei:** Mengumpulkan data dari sampel besar melalui **kuesioner atau wawancara terstruktur**.
    - **Cara Menggunakan:** Rancang **kuesioner**, distribusikan kepada sampel representatif, analisis data menggunakan statistik deskriptif dan inferensial.
    - **Contoh:** Survei kepuasan pelanggan terhadap produk baru.
- **Studi Korelasional:** **Meneliti hubungan antara dua atau lebih variabel** tanpa manipulasi.
    - **Cara Menggunakan:** Kumpulkan data, **hitung koefisien korelasi** untuk menentukan kekuatan dan arah hubungan.
...
- **Desain Eksplanatori:** **Memulai** dengan penelitian **kuantitatif**, **diikuti** dengan **kualitatif** untuk menjelaskan hasil kuantitatif.
    ...
    - **Contoh:** Studi tentang hasil belajar siswa yang diikuti dengan wawancara mendalam tentang faktor-faktor yang mempengaruhi hasil tersebut.
- **Desain Eksploratori:** Memulai dengan penelitian kualitatif, diikuti dengan kuantitatif untuk menggeneralisasi temuan.
    - **Cara Menggunakan:** Lakukan wawancara atau focus group, rancang survei berdasarkan temuan, kumpulkan dan analisis data kuantitatif.
...
#### **Format:**
\[Penulis\]. \[(Tahun)\]. \[Judul artikel\]. *\[Nama Jurnal\]*, \[Volume\](\[Nomor Edisi\]), \[Halaman\]. \[DOI atau URL jika ada\].
**Contoh:**
...
#### **Format:**
\[Penulis\]. \[(Tanggal, Bulan, Tahun)\]. \[Judul artikel\]. \[Nama Surat Kabar\]. \[URL\].
**Contoh:**
...
### **Skripsi** **atau** **Tesis**
#### **Format:**
\[Penulis\]. \[(Tahun)\]. \[Judul skripsi atau tesis\] \[(Jenis skripsi atau tesis, Nama Universitas\]. \[URL jika ada\].
**Contoh:**
Smith, J. A. (2020). *Exploring the impacts of climate change on coastal communities* \[(Tesis master, University of California)\]. https://escholarship.org/uc/item/12345

### **Dokumen** **Pemerintah**
#### **Format:**
\[Nama Organisasi\]. \[(Tahun)\]. \[Judul dokumen\]. \[Penerbit jika berbeda dari penulis\]. \[URL jika ada\].
**Contoh:**
World Health Organization. (2019). *Global tuberculosis report 2019*. https://www.who.int/tb/publications/global_report/en/

### Tips Tambahan:
#### 1. **Penulis:** 
   - Jika ada lebih dari satu penulis, gunakan tanda "&" sebelum penulis terakhir. Contoh: Smith, J., & Brown, L.
   - Jika ada lebih dari 20 penulis, tuliskan penulis pertama hingga ke-19, diikuti dengan “…”, dan penulis terakhir.
#### 2. **Tahun:** 
- Letakkan tahun dalam tanda kurung setelah nama penulis.
#### 3. **Judul:** 
- Judul buku, artikel, atau dokumen italic. Judul artikel jurnal tidak italic, tetapi nama jurnal italic.
#### 4. **Penerbit:** 
- Nama penerbit dituliskan tanpa tambahan seperti "Co." atau "Inc.".
#### 5. **URL/DOI:** 
- Sertakan DOI jika ada. Jika tidak ada DOI, gunakan URL.

Berikut adalah beberapa contoh untuk berbagai jenis sumber:
### Contoh Lain:
#### Buku dengan Banyak Penulis:
Smith, J. A., Johnson, R. B., & Williams, L. K. (2020). *The theory and practice of climate change adaptation*. Oxford University Press.
#### Artikel Jurnal Tanpa DOI:
Brown, L. (2018). Social impacts of environmental change. *Journal of Environmental Studies*, 12(3), 45-67.
#### Website:
American Psychological Association. (n.d.). *APA style guidelines*. https://www.apa.org/style/guidelines

### Contoh Daftar Pustaka Lengkap
1. Wells, A. (2009). *Metacognitive therapy for anxiety and depression in psychology*. Guilford Press.
2. Vogels, A. G. C., Crone, M. R., Hoekstra, F., & Reijneveld, S. A. (2009). Comparing three short questionnaires to detect psychosocial dysfunction among primary school children: a randomized method. *BMC Public Health*, 9(1), 489. https://doi.org/10.1186/1471-2458-9-489
3. Devlin, H. (2010, January 28). Neuron breakthrough offers hope on Alzheimer’s and Parkinson’s. *The Times*. http://www.timesonline.co.uk/tol/news/science/medicine/article7005401.ece
4. Smith, J. A. (2020). *Exploring the impacts of climate change on coastal communities* \[(Tesis master, University of California)\]. https://escholarship.org/uc/item/12345
