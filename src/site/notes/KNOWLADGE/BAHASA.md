---
{"sticker":"emoji//1f324-fe0f","dg-publish":true,"aliases":["BAHASA"],"permalink":"/knowladge/bahasa/","dgPassFrontmatter":true,"noteIcon":""}
---
...
---
---
## SEJARAH, KEDUDUKAN, FUNGSI "BI" (L01)
![[2. Sejarah, Kedudukan, dan Fungsi BI.pptx]]
### SEJARAH Bhs.Indo
![Pasted image 20240701125023.png](/img/user/Pasted%20image%2020240701125023.png)
**- Tanggal 28 Oktober 1928:** merupakan hari yang amat penting, merupakan hari pengangkatan atau penobatan bahasa Indonesia sebagai bahasa persatuan atau sebagai bahasa nasional.
...
3. Untuk **menghindari perpecahan** antar suku-suku bangsa di Indonesia
4. Melayu dapat dijadikan **salah satu budaya** di Indonesia (dalam arti luas)
---
...
---
---
## EJAAN BI (L01/L02/L03)
![[3. Pedoman Umum Ejaan BI.pptx]]
### PENULISAN HURUF 
#### 1. KAPITAL
1. **Huruf pertama** pada **awal kalimat** (**M**ari kita pikirkan)
2. Huruf pertama **kata** yang berkenaan dengan **agama, kitab suci** dan **nama Tuhan** termasuk kata gantinya (**A**llah, **A**l-Qur’an, **B**udha)
3. Huruf pertama petikan (**kutipan**) **langsung**. (Mahasiswa bertanya, “**M**engapa harus berubah?”)
4. Huruf pertama **kata** yang menyatakan **gelar kehormatan, gelar keagamaan, gelar keturunan**, yang diikuti dengan **nama orang**. (**S**ultan **H**amengkubuwono X)
5. Huruf pertama **nama jabatan** atau **pangkat** yang diikuti **nama orang**. Namun, jika *tidak diikuti nama orang huruf besar tidak dipakai*. (**G**ubernur **S**utyoso)
6. Huruf pertama **unsur nama orang**. (**M**egawati **S**oekarno **P**utri)
7. Huruf pertama **kata** yang menyatakan **nama bangsa, nama suku atau nama bahasa**. *Namun, huruf kapital tidak dipakai jika tidak menunjukkan nama*. (bahasa **A**rab, bangsa **I**ndonesia, suku **J**awa)
8. Huruf pertama **nama tahun, nama bulan, nama hari raya dan nama peristiwa sejarah** (tahun **M**asehi, bulan **O**ktober, hari raya **I**dul **F**itri)
9. Huruf pertama **kata** yang menyatakan **nama dalam geografi**. *Namun, huruf kapital tidak dipakai jika tidak diikuti nama*. (**J**alan **J**enderal **S**udirman, **T**erusan **S**uez)
10. Huruf pertama **kata** yang menyatakan **nama lembaga atau badan pemerintah, ketatanegaraan, dan nama dokumen resmi**, termasuk juga singkatannya (**D**ewan **P**erwakilan **R**akyat (DPR))
11. Huruf pertama **nama buku, nama majalah, nama surat kabar, judul karangan**, *kecuali partikel (seperti di, ke dan dari) yang tidak terletak di posisi awal*  (harian **K**ompas)
12. Huruf pertama **istilah kekerabatan** (seperti bapak, ibu, adik dan saudara) yang dipakai sebagai kata ganti atau kata sapaan.Tanya saya kepada ayah, “Apakah **A**yah akan membelikan saya komputer?”)
#### 2. KECIL
1. bukan pada **awal kalimat**
2. bukan **nama orang**
3. penggunaan lain yang **tidak dipersyaratkan pada penggunaan huruf kapital**, *misalnya penulisan **nama jenis*** (**kunci inggris** (bukan kunci Inggris), **pisang ambon** (bukan pisang Ambon))
#### 3. Miring
1. dipakai untuk **menuliskan judul buku, nama majalah, atau nama surat kabar** yang dikutip dalam tulisan, termasuk dalam **daftar pustaka**. (Saya sudah membaca buku ***Salah Asuhan*** karangan Abdoel Moeis)
2. dipakai untuk **menegaskan atau mengkhususkan huruf, bagian kata, kata, atau kelompok kata** dalam kalimat. (Huruf terakhir kata ***abad*** adalah d/  Dia tidak ***di***antar, tetapi ***me***ngantar.)
3. dipakai untuk **menuliskan kata atau ungkapan dalam bahasa daerah atau bahasa asing** (Upacara ***peusijuek*** (tepung tawar) / Nama ilmiah buah manggis ialah ***Garcinia mangostana.***/ ***Weltanschauung*** bermakna ‘pandangan dunia’.)
---
---
## DIKSI, ISTILAH, DEFINISI (L01/L02/L03)
![[4. Diksi, Pembentukan Istilah, dan Definisi.pptx]]

## KALIMAT EFEKTIF (L01/L02/L03)
![[5. Kalimat Efektif.pptx]]

---
---
## PARAGRAF AKADEMIK (L02/L03)
![[6. Paragraf Akademik.pptx]]
### PENGERTIAN PARAGRAF
- **Karangan mini**
- Terdiri **beberapa kalimat** yang tersusun secara **runtut, logis, lengkap, utuh, dan padu**
- Terdiri atas **satu kalimat utama** dan **kalimat penjelas**
- Terdiri atas **beberapa kalimat penjelas**
- **Kalimat utama bertakuk ke dalam**
---
### SYARAT PARAGRAF PADU
#### **1. Kesatuan**  
Untuk menjamin adanya **kesatuan paragraf**, setiap paragraf hanya berisi ***satu pikiran utama*** yang dinyatakan dalam **kalimat topik**.
***Paragraf*** terdiri dari *beberapa kalimat* yang ***seluruhnya harus merupakan kesatuan*** dan **tidak ada** satu kalimat pun **yang sumbang**. Jika terdapat kalimat yang sumbang, paragraf akan rusak kesatuannya.
#### **2. Kepaduan**  
***Paragraf*** dinyatakan terpadu jika *dibangun dengan kalimat-kalimat **yang saling mengait***.
Keterkaitan itu dapat **dibangun melalui repetisi** (pengulangan ) *kata kunci atau sinonim,kata ganti, kata transisi , dan bentuk paralel.*
#### **3. Ketuntasan**  
Ketuntasan ialah **kesempurnaan.**
***Paragraf*** dikatakan sebagai paragraf yang baik, apabila ***cerita dari paragraf itu telah*** tuntas dan **tidak menimbulkan tanda tanya** bagi pembacanya.
#### **4. Keruntutan**  
Keruntutan adalah **penyusunan urutan gagasan dalam karangan**.
Gagasan demi **gagasan** disajikan secara ***runtut dan sistematis***
#### **5. Konsistensi sudut pandang**
Sudut pandang adalah **cara penulis menempatkan diri dalam karangannya**.
Sudut pandang juga ditandai dengan ***keberpihakan penulis dalam karangan***
...
- #### Letak Kalimat Utama=
  ...
  ##### 3. Paragraf Deduktif-Induktif: umum-khusus-umum
	Kalimat utama terletak pada **awal** dan **akhir** paragraf
- #### Fungsi=
  ##### 1. Paragraf naratif: rincian kejadian
  ##### 2. Paragraf deskriptif: 
    penggambaran fakta keadaan, warna, rupa, bentuk, sifat,keadaan, dan lain-lain sehingga pembaca seolah-olah 
  ##### 3. Paragraf eksposisi: 
    menjelaskan (menganalisis) hubungan sebab-akibat, proses, fungsi, dampak, atau identifikasi, klasifikasi objek, dan lain-lain. 
  ##### 4. Paragraf argumentatif 
    mempengaruhi pendapat pembaca agar menolak atau mendukung sikap penulis.
  ##### 5. Paragraf persuasif: 
    mengajak pembaca agar mengikuti sikap penulis. Misalnya: penulisan iklan, promosi, kampanye, dan lain-lain.
---
### POLA PENGEMBANGAN PARAGRAF
#### 1. PERTENTANGAN
   berusaha memperjelas paparannya dengan jalan **mempertentangkan hal-hal yang dibicarakan**
   **pertentangan** merupakan ***proses argumentasi dengan melakukan penolakan***. Oleh karena itu, pertentangan ditargetkan *menolak eksistensi dengan disertai pembuktian*
#### 2. PERBANDINGAN
   berusaha memperjelas paparannya dengan jalan **membandingkan hal-hal yang dibicarakan**.
   **perbandingan** : ***dua hal yg tingkatannya sama*** dan kedua hal tersebut memiliki **perbedaan dan persamaan**
#### 3. ANALOGI
   **membandingkan** sesuatu ***yang dikenal oleh umum*** dengan ***yang kurang dikenal***
#### 4. CONTOH-CONTOH
   digunakan untuk **memberi bukti** atau **penjelasan** terhadap ***generalisasi yang bersifat umum*** agar pembaca dapat dengan mudah menerimanya.
#### 5. SEBAB AKIBAT
   **sebab** dapat berfungsi sebagai ***pikiran utama*** dan **akibat** sebagai ***pikiran penjelas*** atau sebaliknya, yaitu **akibat** sebagai ***pikiran utama*** dan **sebab** sebagai rincian ***penjelasnya***
#### 6. DEFINISI LUAS
   **uraian pengertian**. definisi yang lebih luas terdiri atas ***beberapa paragraf atau satu bab***.
#### 7. KLASIFIKASI
   **pengelompokkan** sesuatu berdasarkan ***kesamaan*** dan ***perbedaan*** sifat, ciri, dan karakter.
...
---
---
## PENGUTIPAN, DAFTAR PUSTAKA (L03)
![[8. Teknik Pengutipan dan Penyusunan Daftar Pustaka.pptx]]
### KUTIPAN
#### –Kutipan langsung : 
   pernyataan yang ditulis dalam susunan kalimat aslinya **tanpa mengalami perubahan sedikitpun**.
   Dibagi menjadi dua:
...
#### –Kutipan tidak langsung : 
   ...
   ##### 1. Kutipan langsung pendek
   ##### 2. Kutipan langsung panjang
![Pasted image 20240701165008.png](/img/user/Pasted%20image%2020240701165008.png)
...
---
---
## "KARANGAN ILMIAH" POPULER (L03/L04)
![[12. Karangan Ilmiah Populer.pptx]]
### Pengertian Karya Ilmiah Populer
**- KBBI** (2002: 370-371) : ilmiah populer memiliki arti **bersifat ilmu**, tetapi *menggunakan **bahasa umum*** sehingga mudah dipahami oleh masyarakat awam (tentang artikel, gaya penulisan karya ilmiah).
**- Gie** (dalam Dalman, 2016: 125) : semacam **karangan ilmiah** *yang mencakup ciri-ciri karangan ilmiah*, yaitu menyajikan *fakta-fakta secara cermat, jujur, netral, dan sistematis*, sedang pemaparannya *jelas, ringkas, dan tepat*.
**- :** **karya tulis** yang berpegang kepada **standar ilmiah**, tetapi *ditampilkan dengan **bahasa umum*** sehingga mudah dipahami oleh masyarakat awam
...
---
---
## "KOMUNIKASI AKADEMIK" (L04)
![[13. Komunikasi Akademik.pptx]]
### Pengertian Komunikasi
- Hovland, Janis, dan Kelley, 
	**- pengertian komunikasi** = suatu proses seseorang (komunikator) menyampaikan stimulus (biasanya berupa kata-kata) dengan tujuan mengubah atau membentuk perilaku orang-orang lainnya.
- Harold Laswell, 
	**- pengertian komunikasi** = suatu proses yang menjelaskan “siapa”, “mengatakan apa”, dengan “saluran apa”, “kepada siapa” dan “dengan akibat apa” atau “hasil apa”
---
### Komunikasi Efektif
- Komunikasi yang **mampu menyampaikan gagasan dari pengujar/pembicara ke penyimak** sehingga ***menimbulkan gagasan yang sama*** antara pengujar/pembicara dan penyimak.
- Komunikasi yang **menimbulkan daya tarik**
#### Beberapa hal yang perlu diperhatikan dalam menghasilkan komunikasi efektif:
##### 1. PENGGUNAAN RAGAM BAHASA
- ###### Formal (resmi), 
	dipergunakan untuk acara yang bersifat formal. Menggunakan tata bahasa yang baku formal.
- ###### Semi-Formal, 
	dipergunakan untuk acara yang bersifat semi-formal. Mulai ada percampuran antara tata bahasa baku formal dengan yang tidak baku.
- ###### Tidak/Non-Formal, 
	dipergunakan untuk acara yang tidak resmi, atau acara yang mengarah kepada suasana yang lebih santai. Bersifat tidak baku-formal.
##### 2. PENGUCAPAN KALIMAT
- ###### Phrasering
	melakukan pemenggalan pengucapan kalimat secara benar.
- ###### Intonasi
	memilih nada kalimat secara benar.
- ###### Dialek, 
	pengaruh gaya / intonasi bahasa ibu yang tetap mewarnai pengucapan kalimat.
- ###### Cheer-up, 
	pada umumnya, kata atau kalimat bagian paling belakang, diucapkan dengan nada meninggi / naik, bertujuan membangkitkan semangat yang mendengarnya.
---
### PENGERTIAN PRESENTASI AKADEMIK
#### Presentasi 
   : **pidato akademis** atau pidato **ilmiah** dihadapan sekelompok pendengar dengan tujuan untuk ***menyampaikan informasi, hasil temuan penelitian, kajian ilmiah, atau pertanggungjawaban atas tugas*** yang diberikan oleh dosen atau institusi.
#### Presentasi ilmiah 
   : **penyajian karya tulis** atau karya **ilmiah** seseorang di depan forum undangan atau peserta.
### Pidato Akademik
#### KRITERIA BERPIDATO
